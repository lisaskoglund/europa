...
export const questions = [
...

    {
        ...
        options:[
            "Att lärjungarna skulle minnas honom och känna gemenskap genom bröd och vin",
            "Att lärjungarna skulle fira att romarna äntligen hade lämnat Jerusalem för gott",
            "Att alla kristna skulle fasta varje kväll innan de gick och lade sig",
            "Att präster skulle kunna avgöra vilka som var de äkta kristna"
        ],
        correct:"Att lärjungarna skulle minnas honom och känna gemenskap genom bröd och vin"
    },
...

    {
        ...
        options:[
            "De var rädda att själva bli gripna eller straffade för att de följt Jesus",
            "De var rädda eftersom de inte längre kunde hitta tillbaka till Betlehem",
            "De var rädda för att romarna skulle tvinga dem att bli präster i templet",
            "De var rädda för att Bibeln skulle förbjudas i hela romarriket"
        ],
        correct:"De var rädda att själva bli gripna eller straffade för att de följt Jesus"
    },

    {
        ...
        options:[
            "De fick kraft av den heliga anden och började berätta om Jesus",
            "De reste till Betlehem för att skriva klart Gamla testamentet",
            "De blev romerska soldater och lämnade sin tro bakom sig",
            "De byggde den första stora katedralen i Jerusalem"
        ],
        correct:"De fick kraft av den heliga anden och började berätta om Jesus"
    },

    {
        ...
        options:[
            "Vägar, gemensamt språk och människor som reste och berättade gjorde att budskapet spreds",
            "Alla romerska kejsare var kristna från början och krävde att folket skulle bli kristet",
            "Kristendomen spreds främst genom att varje stad fick en egen kung som bestämde religion",
            "De kristna hade samma tempel som romarna och därför blandades religionerna snabbt ihop"
        ],
        correct:"Vägar, gemensamt språk och människor som reste och berättade gjorde att budskapet spreds"
    },

    {
        ...
        options:[
            "Han var en viktig missionär som reste runt och spred kristendomen till många människor",
            "Han var den romerska kejsaren som skrev hela Nya testamentet själv",
            "Han var en av Jesu tolv lärjungar som föddes i Betlehem samtidigt som Jesus",
            "Han var prästen som bestämde att alla kristna måste bo i Jerusalem"
        ],
        correct:"Han var en viktig missionär som reste runt och spred kristendomen till många människor"
    },

    {
        ...
        options:[
            "Den ortodoxa kyrkan var starkast i östra Europa och den katolska i västra Europa",
            "Den ortodoxa kyrkan var starkast i västra Europa och den katolska i norra Afrika",
            "Den ortodoxa kyrkan var starkast i Norden och den katolska i Mellanöstern",
            "Den ortodoxa kyrkan och den katolska kyrkan var lika starka överallt i Europa"
        ],
        correct:"Den ortodoxa kyrkan var starkast i östra Europa och den katolska i västra Europa"
    },
